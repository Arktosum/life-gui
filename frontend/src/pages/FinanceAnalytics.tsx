...
export default function FinanceAnalytics() {
  ...
  for (const item of transactions) {
    const daily_datetime = moment(item.updatedAt).format("YYYY-MM-DD");
    const weekly_datetime = moment(item.updatedAt).week();
    const monthly_datetime = moment(item.updatedAt).format("YYYY-MM");
