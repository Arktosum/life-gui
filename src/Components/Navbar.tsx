...
function Navbar(props : Props) {
  ...
  return (
    <div className='bg-[#141414] h-full flex justify-evenly items-center '>
      <Link className="h-full" to="/todos"><div className={navLinkStyle+(currentPage=='todos' ? 'border-b-green-500' : 'border-b-[#5B5B5B]')}><span className='duration-[500ms] hover:-translate-y-2 ease-in-out'>Todos</span></div></Link>
